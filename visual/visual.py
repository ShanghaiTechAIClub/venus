...
from base import ModelToolBase
import matplotlib
...
class ModelPlotter(ModelToolBase):
    ...
    def regis_plot(self, plotter, kwargs):
        ...
        self.plots.append(plotter(**kwargs))
...
class VisdomPlotter(ModelToolBase):
...
class TensorboardPlotter(ModelToolBase):
    vis_funcs = {'WeightRatio':WeightRatioTB, 'Norm':NormTB, 'MeanStd':MeanStdTB}
